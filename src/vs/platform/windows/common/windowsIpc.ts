...
export interface IWindowsChannel extends IChannel {
	...
	call(command: 'openWindow', arg: [string[], { forceNewWindow?: boolean, forceReuseWindow?: boolean, forceBestWindow?: boolean, forceOpenWorkspaceAsFile?: boolean }]): TPromise<void>;
