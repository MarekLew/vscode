...
export interface IWindowsChannel extends IChannel {
	...
	call(command: 'openWindow', arg: [number, string[], { forceNewWindow?: boolean, forceReuseWindow?: boolean, forceBestWindow?: boolean, forceOpenWorkspaceAsFile?: boolean }]): TPromise<void>;
...
export class WindowsChannelClient implements IWindowsService {
	...
	openWindow(windowId: number, paths: string[], options?: { forceNewWindow?: boolean, forceReuseWindow?: boolean, forceBestWindow?: boolean, forceOpenWorkspaceAsFile?: boolean }): TPromise<void> {
